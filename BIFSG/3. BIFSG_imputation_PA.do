...
Program Description: Imputation using BIFSG estimates.  

Input:
	- PA Compensation Data with BIFSG estimates 		  -"$analysis\PA_claims_sample_observed_and_imputed_adjusted.dta"
	
Output:
	- PA compensation data with imputed BIFSG race values 
=====================================================================================*/
...
cap log close
cd "$log_dir"
log using "imputation_BIFSG_PA_$out_date.smlc", append
...
/*=====================================================================================
Step 1: Importing PA data with raw and BIFSG estimates 
--------------------------------------------------------------------------------------
=======================================================================================*/ 
use "$analysis\PA_claims_sample_observed_and_imputed_adjusted.dta"
...
clear
use "$analysis\PA_claims_sample_observed_and_imputed_adjusted.dta", clear //starting with the original dataset and then adding imputed datasets to this 
...
save "$analysis\PA_BIFSG_imputed_data.dta", replace
